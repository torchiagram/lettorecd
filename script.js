...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function unlock() {
        ...
        else { widget.play(); setTimeout(() => widget.pause(), 100); }
    }

    permBtn.addEventListener('click', unlock);
    permBtn.addEventListener('touchend', (e) => { e.preventDefault(); unlock(); });
    ...
    playlists.forEach((_, i) => {
        ...
        div.innerHTML = `<img src="img/playlist_${i+1}.png" class="cd-img" data-index="${i}" draggable="false">`;
    ...
    function startDrag(e) {
        ...
        overlay.classList.add('active'); // Attiva overlay nero

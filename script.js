const playlists = [
    ...
    },
    {
        songs: [
            ...
            { title: 'Trapt - Headstrong',               url: 'https://soundcloud.com/traptmusic/trapt-headstrong?in=user-345356873/sets/the-offsprings' },
    ...
    {
        songs: [
            { title: '50 Cent - P.I.M.P.',               url: 'https://soundcloud.com/dc_mt_louko/50cent-pimp?in=noa-kelly/sets/2000s-throw-backs' },
            { title: 'Black Eyed Peas - My Humps',       url: 'https://soundcloud.com/bajatumusica/black-eyes-peas-my-humps?in=noa-kelly/sets/2000s-throw-backs' },
            ...
            { title: 'Black Eyed Peas - Where Is The Love?', url: 'https://soundcloud.com/black-eyed-peas-official/where-is-the-love-album' },
            { title: "Black Eyed Peas - Don't Phunk With My Heart", url: 'https://soundcloud.com/black-eyed-peas-official/dont-phunk-with-my-heart-1' },
            { title: "Destiny's Child - Say My Name",    url: 'https://soundcloud.com/sowce/destinys-child-say-my-name' },
            { title: "Eamon - I Don't Want You Back",    url: 'https://soundcloud.com/mix-93-3-all-the-mix/eamon-i-dont-want-you-back' },
            { title: 'Panjabi MC - Mundian To Bach Ke',  url: 'https://soundcloud.com/panjabi-mc-official/mundian-to-bach-ke-2' },
            { title: 'Ginuwine - Pony',                  url: 'https://soundcloud.com/user-190562091-180395941/12-ginuwine-pony' },
            ...
            { title: 'Beyoncé - Crazy In Love ft. JAY-Z', url: 'https://soundcloud.com/e1oovdghddfw/crazy-in-love-ft-jay' },
            { title: '50 Cent - In Da Club',             url: 'https://soundcloud.com/leo-ali-306816420/50cent-in-da-club-hd' },
...
// ── Carica traccia ────────────────────────────────────────────────
// Su Safari iOS auto_play:true dentro load() spesso non basta.
// Ascoltiamo READY e forziamo play() esplicito ogni volta.
// Il READY viene unbindato subito per evitare listener duplicati.
function loadTrack(plIdx, sIdx) {
    if (!widget) return;
    const song = playlists[plIdx].songs[sIdx];
    trackTitle.innerText = song.title;

    widget.bind(SC.Widget.Events.READY, function onReady() {
